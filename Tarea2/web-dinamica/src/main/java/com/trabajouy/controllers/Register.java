...
public class Register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usrType.equals("empresa")) {
            ...
            try {
                ContU.altaEmpresa(nickname, name, apellido, email, password, uniqueFileName, name, descripcion,
                        website);
            ...
            if (usrType.equals("postulante")) {
                ...
                try {
                    ContU.CrearPostulante(nickname, name, apellido, email, password, uniqueFileName, fechaN,
                            nacionalidad);
                    filePart.write(filePath);
