...
public class ManejadorUsuario {
	...
	public void modificarEmpresa(String nickname, String nombre, String Apellido, String email, String contraseña, String foto, String empresa, String descripcion, String link) {
		usuariosPorEmail.remove(getUsuario(nickname).getEmail());
		usuariosPorEmail.put(email, getUsuario(nickname));
		((Empresa) getUsuario(nickname)).modificarEmpresa(nombre, Apellido, contraseña, foto, empresa, descripcion, link);
	}
	...
	public void modificarPostulante(String nickname, String nombre, String apellido, String email, String contraseña,
			String foto, LocalDate date, String nacionalidad) {
		usuariosPorEmail.remove(getUsuario(nickname).getEmail());
		usuariosPorEmail.put(email, getUsuario(nickname));
		((Postulante) getUsuario(nickname)).modificarPostulante(nombre, apellido, contraseña, foto, date, nacionalidad);
	}
}
